...
public class ResponsableService {
    ...
    public ResponsableService(ResponsableRepository responsableRepository, RoleRepository roleRepository, PasswordEncoder passwordEncoder, ModelMapper modelMapper) {
    ...
    public Responsable createResponsable(ResponsableRequest responsableRequest) {
        ...
        responsable.setRole(roleRepository.findById(1l).get());
